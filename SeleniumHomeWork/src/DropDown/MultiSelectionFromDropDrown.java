...
import org.openqa.selenium.interactions.Action;
	...
	from the list using 'http://demos.devexpress.com/aspxeditorsdemos/ListEditors/MultiSelect.aspx'.*/


public class MultiSelectionFromDropDrown {
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		System.out.println("Number of items in the List box is: "+ options.size());
